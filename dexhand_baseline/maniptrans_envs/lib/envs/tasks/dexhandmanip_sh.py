...
class DexHandManipRHEnv(VecTask):
    ...
    def pre_physics_step(self, actions):
        ...
        if self.use_pid_control:
            ...
            rotation_error = actions[:, 3:root_control_dim]
            ...
            force = actions[:, 0:3] * self.dt * self.translation_scale * 500
            torque = actions[:, 3:6] * self.dt * self.orientation_scale * 200
